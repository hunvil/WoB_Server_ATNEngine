...
*/
public class ATNPredictionRunnable implements Runnable {
 ...
 public ATNPredictionRunnable(GameEngine gameEngine, Ecosystem zone, ATNEngine atnEngine, 
...
//     String csv = atnEngine.getBiomassCSVString(manipulation_id);
//
//     try {
